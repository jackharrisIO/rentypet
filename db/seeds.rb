...
User.create(email: "casper@test.com", password: "123456")
User.create(email: "billy@test.com", password: "123456")
User.create(email: "shelia@test.com", password: "123456")
User.create(email: "betty@test.com", password: "123456")
